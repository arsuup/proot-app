...
const styles = StyleSheet.create({
  ...
  conversationButton: { alignItems: 'center', backgroundColor: '#F2F0EB', borderRadius: 16, height: 36, justifyContent: 'center', width: 36 },
  ...
  newConversationButton: { alignItems: 'center', backgroundColor: colors.primary, borderRadius: 12, marginTop: 17, paddingVertical: 12 },
